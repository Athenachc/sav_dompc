...
int main(int argc, char **argv)
{
    ...
    while(ros::ok()){
        ...
        // Hovering pt
        target_pose_1.ref.pose.position.x = current_object_pose.pose.position.x-0.022; //badminton: -0.075; ball: -0.08
        target_pose_1.ref.pose.position.y = current_object_pose.pose.position.y+0.00; //badminton: +0.06; ball: +0.03
        target_pose_1.ref.pose.position.z = 1; //badminton: 0.8; ball: 1
        ...
        // Approaching pt
        target_pose_2.ref.pose.position.x = current_object_pose.pose.position.x-0.022; //badminton: -0.075; ball: -0.02
        target_pose_2.ref.pose.position.y = current_object_pose.pose.position.y+0.00; //badminton: +0.06; ball: +0.00
        target_pose_2.ref.pose.position.z = 0.6; //badminton: 0.8; ball: 0.6
        ...
        // Grasping pt
        target_pose_3.ref.pose.position.x = current_object_pose.pose.position.x-0.022; //badminton: -0.075; ball: -0.02
        target_pose_3.ref.pose.position.y = current_object_pose.pose.position.y+0.00; //badminton: +0.06; ball: -0.00
        target_pose_3.ref.pose.position.z = 0.23; //badminton: 0.4; ball: 0.23
        ...
        // Releasing pt
        target_pose_5.ref.pose.position.x = -1.5;
        target_pose_5.ref.pose.position.y = 1;
        target_pose_5.ref.pose.position.z = 0.5;
        ...
        target_pose_6.ref.pose.position.y = 1;
        target_pose_6.ref.pose.position.z = 0.5;
            ...
            case COMMAND:{
                if(fsm_info.is_waiting_for_command){
                    if(!target_1_reached){
                        ...
                        if(abs(local_pose.pose.position.x - target_pose_1.ref.pose.position.x) < 0.03
                        && abs(local_pose.pose.position.y - target_pose_1.ref.pose.position.y) < 0.02
                    ...
                    if(target_1_reached){
                        ...
                        if(abs(local_pose.pose.position.x - target_pose_2.ref.pose.position.x) < 0.04
                        && abs(local_pose.pose.position.y - target_pose_2.ref.pose.position.y) < 0.03
                    ...
                    if(target_2_reached){
                        ...
                        if(abs(local_pose.pose.position.x - target_pose_3.ref.pose.position.x) < 0.03
                        && abs(local_pose.pose.position.y - target_pose_3.ref.pose.position.y) < 0.02
                        && abs(local_pose.pose.position.z - target_pose_3.ref.pose.position.z) < 0.1){
